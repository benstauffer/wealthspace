...
import EditAccount from "../accounts-table/edit-account";
...
const CashFlowRow = ({
  ...
  return (
    <TableRow className="bg-gray-100">
      <TableCell style={{ paddingLeft: '52px' }} className="border-b border-gray-200 flex-1 text-start">{account.name}</TableCell>
